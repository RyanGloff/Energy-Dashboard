...
-- ALTER SEQUENCE public.alarms_id_seq RESTART WITH 0;
-- CREATE SEQUENCE IF NOT EXISTS public.devices_id_seq;
-- ALTER SEQUENCE public.devices_id_seq RESTART WITH 0;
-- CREATE SEQUENCE IF NOT EXISTS public.emeter_data_id_seq;
-- ALTER SEQUENCE public.emeter_data_id_seq RESTART WITH 0;
-- CREATE SEQUENCE IF NOT EXISTS public.errors_id_seq;
-- ALTER SEQUENCE public.errors_id_seq RESTART WITH 0;
-- CREATE SEQUENCE IF NOT EXISTS public.faults_id_seq;
-- ALTER SEQUENCE public.faults_id_seq RESTART WITH 0;
-- CREATE SEQUENCE IF NOT EXISTS public.logs_id_seq;
-- ALTER SEQUENCE public.logs_id_seq RESTART WITH 0;
